...
//				.'REQUEST curl info: '.print_r($this->requestInfo, true));
		...
		if($curlErrorNumber > 0)
		{
			...
			if (DEBUG)
				\CB24Log::Add('REQUEST curl error: '.'['.$curlErrorNumber.'] '.$errorMsg);
		...
		if (DEBUG)
//			\CB24Log::Add('REQUEST curl decoded JSON result: '.print_r($jsonResult, true));
